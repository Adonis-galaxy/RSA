...
class DPTDepthModel(DPT):
    ...
    def forward(self, x, scale_pred, shift_pred):
        inv_relative_depth = super().forward(x).squeeze(dim=1)
        # inv_relative_depth = (inv_relative_depth - inv_relative_depth.min()) / (inv_relative_depth.max() - inv_relative_depth.min())
